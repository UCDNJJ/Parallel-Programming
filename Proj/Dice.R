                        ...
                        orderMatters=FALSE)
{
  ...
  if (length(eventList) < nrolls)
  {
    eventList = lapply(c(eventList, rep(0, nrolls - length(eventList))), 
      function(x){x = (if (max(x) == 0) ndicePerRoll:(ndicePerRoll*nsidesPerDie) else x)})    
  }
  ...
  for (boundaryVal in 1 : nsidesPerDie)
  {
                           ...
                           (!dropLowest && boundaryVal == nsidesPerDie)) 0 else numDiceToDrop))
    {
      ...
      for (numBsKept in 1 : nkept)
      {
        ...
        print(paste("boundaryVal: ", boundaryVal, "Os: ", numOs, "BsK: ", numBsKept, "numBs: ", numBs, "numIs: ", numIs))
...
paste("\n\nIn this class, boundaryVal is ", boundaryVal, ", numOs is ", numOs,", numBsKept is", numBsKept, ", numBs is ", numBs, ", and numIs is ", numIs, "\n", sep="")
        ...
        print(paste("numArrange: ", numArrangementsOfDice))
        ...
        print(paste("inner: ", innerBoundary, "outer: ", outerBoundary, "rangeO: ", rangeOfOVals, "rangeI:", rangeOfIVals))
        print(possibleIValsVec)
        ...
        print(paste("numArrange2nd: ", numArrangementsOfDice))
        ...
        else
        {
          ...
          if (dim(outcomeMatrix)[1] > 0)
          {
            ...
            for (rowNum in 1 : nrow(outcomeMatrix))
            {
              ...
              print(currentSum-sumModifier - (nkept-1))
  ...
  #print("final")
  #print(list(probabilities = sumTallyMatrix, average = overallAverageSum))
